...
export namespace TokenURISetEvent {
  export type InputTuple = [tokenURI: string];
  export type OutputTuple = [tokenURI: string];
  export interface OutputObject {
    tokenURI: string;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface Token extends BaseContract {
  ...
  setTokenURI: TypedContractMethod<[tokenURI_: string], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[tokenURI_: string], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    ...
    TokenURISetEvent.InputTuple,
    TokenURISetEvent.OutputTuple,
    TokenURISetEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "TokenURISet(string)": TypedContractEvent<
      TokenURISetEvent.InputTuple,
      TokenURISetEvent.OutputTuple,
      TokenURISetEvent.OutputObject
    >;
    TokenURISet: TypedContractEvent<
      TokenURISetEvent.InputTuple,
      TokenURISetEvent.OutputTuple,
      TokenURISetEvent.OutputObject
    >;
